...
class SignUpForm(ft.UserControl):
    ...
    def build(self):
        ...
        self.text_signup=ft.ElevatedButton(text="Регистрация",color=ft.colors.WHITE,width=150,height=50,on_click= self.btn_signup)
        self.text_signin=ft.Row(controls=[ft.Text(value="Уже есть аккаунт?"),ft.TextButton(text="Войдите",on_click=self.btn_signin)],alignment=ft.MainAxisAlignment.CENTER)
