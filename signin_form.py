...
class SignInForm(ft.UserControl):
    ...
    def build(self):
        ...
        self.text_signin=ft.ElevatedButton(text="Войти",color=ft.colors.WHITE,width=150,height=50,on_click= self.btn_signin)
        self.text_signup=ft.Row(controls=[ft.Text(value="Еще нет аккаунта?"),ft.TextButton(text="Зарегистрируйтесь",on_click=self.btn_signup)],alignment=ft.MainAxisAlignment.CENTER)
